        ...
        DB::table('specializations')->insert([
            [
                ...
                'description' => htmlspecialchars('<p><b>Chuyên gia tư vấn dinh dưỡng&nbsp;</b></p><ul><li>BookingCare là Nền tảng Y tế chăm sóc Sức khỏe toàn diện, trong đó có cung cấp dịch vụ tư vấn dinh dưỡng từ xa.</li>
                    ...
                    <p>Ngoài những lợi ích nêu trên, khách hàng có thể liên hệ với chúng tôi để được hỗ trợ, sắp xếp lịch tư vấn phù hợp</p><br>'),                'image' => "https://cdn.bookingcare.vn/fo/2020/12/20/111237-tam-ly-2.jpg",
                'slug' => 'dinhduong',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now()
            ],
